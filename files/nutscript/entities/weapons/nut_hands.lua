...
if (CLIENT) then
	function SWEP:PreDrawViewModel(viewModel, weapon, client)
		...
		if (hands) then
			viewModel:SetModel("models/weapons/c_arms_citizen.mdl")
			viewModel:SetSkin(self.SkinTranslation[client:GetModel()], 0)
			viewModel:SetBodyGroups("0000000")
		end
	end
end
