...
concommand.Add("checkplychars", function(ply, cmd, args)
    local id = ply:SteamID64()
	nut.db.query("SELECT * FROM nut_characters WHERE _steamID ='".. id .."'", function(data)
        for k, v in ipairs(data) do
            print("Name: " .. data[k]._name .. ", Faction: " .. data[k]._faction)
        end
    end)
end)