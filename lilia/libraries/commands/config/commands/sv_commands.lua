    ...
    "liststaff",
    {
        ...
        onRun = function(client)
            for _, clients in ipairs(player.GetAll()) do
                if clients:isStaff() then
                    client:ChatPrint("Staff Member: " .. clients:Name())
                end
            end
        end
    }
...
lia.command.add(
    "listvip",
    {
        ...
        onRun = function(client)
            for _, clients in ipairs(player.GetAll()) do
                if clients:isVIP() then
                    client:ChatPrint("VIP Member: " .. clients:Name())
                end
            end
        end
    }
...
lia.command.add(
    "listusers",
    {
        ...
        onRun = function(client)
            for _, clients in ipairs(player.GetAll()) do
                if clients:isUser() then
                    client:ChatPrint("User Member: " .. clients:Name())
                end
            end
        end
    }
