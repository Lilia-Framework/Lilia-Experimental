...
function PANEL:loadBackground()
    if (not DynamicBackgrounds or table.Count(DynamicBackgrounds.scenes) == 0) or MODULErCreationTransparentBackground then self.blank = true end
    local url = MODULEkgroundURL
    if url and url:find("%S") then
        ...
        if MODULErMenuBGInputDisabled then
...
function PANEL:hoverSound()
    LocalPlayer():EmitSound(unpack(MODULErHover))
end

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function PANEL:clickSound()
    LocalPlayer():EmitSound(unpack(MODULErClick))
end

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function PANEL:warningSound()
    LocalPlayer():EmitSound(unpack(MODULErWarning))
end
