...
function MODULE:CreateSalaryTimer(client)
    ...
    local delay = (class and class.payTimer) or (faction and faction.payTimer) or MODULE.SalaryInterval
    if PayAmount > 0 then
        timerFunc(
            timerID,
            delay,
...
function MODULE:VerifySalaryLimit(client, _, _)
    if MODULE.SalaryThreshold > 0 and client:getChar():getMoney() >= MODULE.SalaryThreshold then return true end
    return false
end
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
