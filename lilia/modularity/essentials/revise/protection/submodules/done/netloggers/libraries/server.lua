...
function net.Incoming(len, client)
    ...
    if not status then ServerLog(string.format("Error during net message (%s). Reasoning: %s \n", name, error)) end
end

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function concommand.Run(ply, cmd, args)
    if not IsValid(ply) then return MODULE.ConsoleRun(ply, cmd, args) end
    if not cmd then return MODULE.ConsoleRun(ply, cmd, args) end
    ...
    return MODULE.ConsoleRun(ply, cmd, args)
end
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
