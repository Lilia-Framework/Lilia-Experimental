...
function PANEL:onFinish()
    ...
    MODULE:createCharacter(self.context):next(
        function()
            onResponse()
...
function PANEL:Init()
    ...
    self.prev.DoClick = function(_) self:previousStep() end
