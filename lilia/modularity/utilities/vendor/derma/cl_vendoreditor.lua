...
local PANEL = {}
--------------------------------------------------------------------------------------------------------------------------
local EDITOR = include(MODULE.path .. "/libraries/libs/cl_vendor.lua")
--------------------------------------------------------------------------------------------------------------------------
local COLS_MODE = 2
--------------------------------------------------------------------------------------------------------------------------
local COLS_PRICE = 3
...
function PANEL:Init()
    ...
    self.bubble.OnChange = function(_, value)
        EDITOR.bubble(value)
    end
    ...
    self.useMoney.OnChange = function(_, value)
    ...
    self.faction.DoClick = function(_)
