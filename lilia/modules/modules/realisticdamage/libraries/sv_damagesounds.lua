...
function MODULE:EntityTakeDamage(target, dmginfo)
    ...
    if attacker:IsPlayer() and IsValid(attacker) and IsValid(weapon) and table.HasValue(lia.config.MeleeWeapons, weapon:GetClass()) and lia.config.MeleeDamageBonus then
