...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AttributesCore:StartCommand(cllient, cmd)
	if self.StaminaSlowdown and (not cllient:IsNoClipping() and cllient:getNetVar("brth", false) and cmd:KeyDown(IN_JUMP)) then
